...
const MovieSection = () => {
  ...
  const RecommandedMovies = () => {
    setActiveCategory('Recommended Movies');
    navigate('/recommanded-movies');
  };
  ...
  const movieData = {
    // You can populate this object with fetched or static data
  };
  ...
  return (
    <>
      ...
      <section className="w-full bg-black py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex justify-center mb-10 space-x-4">
            ...
            <button
              onClick={RecommandedMovies}
              className={`px-4 py-2 rounded-full font-semibold ${
                activeCategory === 'Recommended Movies'
                  ? 'bg-yellow-500 text-black'
                  : 'bg-gray-700 text-white hover:bg-yellow-500'
              } transition duration-300`}
            >
          ...
          {/* Movie Grid (empty until data is added) */}
              ...
              >
                <div className="relative aspect-w-3 aspect-h-4 w-full">
                  ...
                  <div className="absolute inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                    <Play
                      size={48}
                      className="text-white cursor-pointer mb-3 animate-pulse"
                    />
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-start justify-center h-full text-left px-6 md:px-16">
          <motion.div
          ...
          >
            ...
            <button
              className="text-2xl bg-yellow-500 rounded-full p-2 transition duration-300 transform hover:scale-105 hover:shadow-yellow-500/50 hover:shadow-lg"
